...
!
      if(boundary_dem==1) allocate(part_vir(np))
...
!.......................................................
      if(LBM)then
!.....calculate maximum velocity at fluid nodes
...
!          if(umax.lt.uvelocity) umax=uvelocity
   	  write(13,100) ix,iy,iz,ux
  100     format(1x,i6,1x,i6,1x,i6,1x,g10.4)
      return
	End subroutine
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
